...
OPTIONAL_TABLE_SOURCES = {
    ...
    "red_compresoras_canonica": "red_compresoras_canonica.parquet",
    "red_loops_canonica": "red_loops_canonica.parquet",
    "red_tramos_parametros_canonica": "red_tramos_parametros_canonica.parquet",
